...
@XmlRootElement(name = "StanjePrehoda")
public class StanjePrehoda {

    @XmlElementRef(name = "ime", namespace = "http://um.si/SOA/v2/12/2015", type = JAXBElement.class, required = false)
